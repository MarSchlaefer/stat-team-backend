...
puts "Game"
Game.create(:id => 1, :date => Time.now.strftime("%m/%d/%Y"), :time => Time.now.strftime("%I:%M:%S"), :timer => "20:00", :period => 1)

puts "Team"
Team.create(:id => 1, :name => "Colgate", :home => true, :game_id => 1, :logo => "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/Colgate_Raiders_logo.svg/2000px-Colgate_Raiders_logo.svg.png", :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :ftp => 0)
Team.create(:id => 2, :name => "Bucknell", :home => false, :game_id => 1, :logo => "https://upload.wikimedia.org/wikipedia/en/thumb/3/3a/Bucknell_Bison_logo.svg/1200px-Bucknell_Bison_logo.svg.png", :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :ftp => 0)

puts "Players"
puts "...Home"
Player.create(:id => 1, :name => "N. Cummings", :number => 00, :position => "G", :team_id => 1, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://gocolgateraiders.com/images/2018/10/2/Cummings_Nelly_29_web_.jpg?width=80")
Player.create(:id => 2, :name => "J. Burns", :number => 01, :position => "G", :team_id => 1, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://gocolgateraiders.com/images/2018/10/2/Burns_Jordan_11_web_.jpg?width=80")
Player.create(:id => 3, :name => "Z. Light", :number => 02, :position => "G", :team_id => 1, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://gocolgateraiders.com/images/2018/10/2/Light_Zach_31_web_.jpg?width=80")
Player.create(:id => 4, :name => "S. Lindgren", :number => 04, :position => "F", :team_id => 1, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://gocolgateraiders.com/images/2018/10/2/Lindgren_Sam_19_web_.jpg?width=80")
Player.create(:id => 5, :name => "M. Regisford", :number => 05, :position => "F", :team_id => 1, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://gocolgateraiders.com/images/2018/10/2/Regisford_Malcolm_17_web_.jpg?width=80")
...
puts "...Away"
Player.create(:id => 15, :name => "P. Newman", :number => 00, :position => "C", :team_id => 2, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://bucknellbison.com/images/2018/9/20/Newman_Paul.jpg?width=80")
Player.create(:id => 16, :name => "K. Mackenzie", :number => 01, :position => "G", :team_id => 2, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://bucknellbison.com/images/2018/9/20/Mackenzie_Kimbal.jpg?width=80")
Player.create(:id => 17, :name => "W. Ellis", :number => 02, :position => "F", :team_id => 2, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://bucknellbison.com/images/2018/9/20/Ellis_Walter.jpg?width=80")
Player.create(:id => 18, :name => "J. Sotos", :number => 03, :position => "G", :team_id => 2, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://bucknellbison.com/images/2018/9/20/Sotos_Jimmy.jpg?width=80")
Player.create(:id => 19, :name => "N. Sestina", :number => 04, :position => "CF", :team_id => 2, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://bucknellbison.com/images/2018/9/20/Sestina_Nate.jpg?width=80")
Player.create(:id => 20, :name => "J. Sechan", :number => 05, :position => "G", :team_id => 2, :tp => 0, :fgm => 0, :fga => 0, :fgp => 0, :ygm => 0, :yga => 0, :ygp => 0, :reb => 0, :orb => 0, :drb => 0, :ast => 0, :stl => 0, :blk => 0, :to => 0, :pf => 0, :ftm => 0, :fta => 0, :img => "https://bucknellbison.com/images/2018/9/20/Sechan_Jordan.jpg?width=80")
